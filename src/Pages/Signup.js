...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    if (
      ...
      try {
        const response = await fetch('https://petbackend-7p9w.onrender.com/signup', {
          method: 'POST',
          headers: {
      ...
      <div style={boxStyle}>
        <div className="card" style={cardStyle}>
          <div className="col-md-6 col-lg-7 d-none d-md-block">
            <img
              src="https://img.freepik.com/free-vector/pet-grooming-concept-illustration_114360-19918.jpg?size=626&ext=jpg&ga=GA1.1.455358885.1692768358&semt=ais"
              alt="signup form"
              className="img-fluid"
              style={imageStyle}
            />
