          ...
          <SwiperSlide className='py-12 lg:py-16' key={index}>
            <div className="container mx-auto text-center lg:text-left">
              ...
              items-center lg:flex-row'>
                {/* Your image should be rendered like this */}
                <div className='flex-1'>
                  <h1 className='text-blue text-[36px]
                  leading-tight lg:text-[72px] lg:leading-[98px]
                  font-extrabold mb-4'>{title}</h1>
                  <p className='text-base lg:text-[18px]
                  lg:leading-8 max-w-[540px] mb-8'>{subtitle}</p>
